...
if (configurator) {
  ...
  const names = { "vera-rubin": "Spartan", blackwell: "Spartan Cluster", "5090ti": "Spartan Edge" };
...
const layerContent = {
  ...
  systems: ["Nucore GPU Systems", "The Spartan system is the compute base, built on NVIDIA architecture and modified for agentic AI workloads.", "Spartan · Modified NVIDIA base"]
};
